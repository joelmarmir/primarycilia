...
# Define file paths
phenodata_path <- "/users/genomics/jmartinez/data/05_tables/Aydin_2019/Aydin_2019_Ascl1_phenotab1.csv"
counts_dir <- "/users/genomics/jmartinez/a_primary_cilia_project/05_counts/"
